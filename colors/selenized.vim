...
" Last Updated: Fri 15 Nov 2024 02:42:39 AM EST
...
if &background ==# 'dark'
  ...
  hi NormalFloat guifg=NONE guibg=#184956 gui=NONE cterm=NONE
  hi WinBar guifg=#cad8d9 guibg=#184956 gui=bold cterm=bold
  hi WinBarNC guifg=#cad8d9 guibg=#184956 gui=bold cterm=bold
  ...
  hi LspInlayHint guifg=#72898f guibg=NONE gui=NONE cterm=NONE
  ...
  hi RedrawDebugClear guifg=NONE guibg=#ebc13d gui=reverse cterm=reverse
  hi RedrawDebugComposed guifg=NONE guibg=#84c747 gui=reverse cterm=reverse
  hi RedrawDebugRecompose guifg=NONE guibg=#ff665c gui=reverse cterm=reverse
  hi FloatShadow guifg=NONE guibg=#184956 gui=NONE cterm=NONE
  hi FloatShadowThrough guifg=NONE guibg=#184956 gui=NONE cterm=NONE
  ...
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi NormalFloat guifg=NONE guibg=#e9e4d0 gui=NONE cterm=NONE
  hi WinBar guifg=#3a4d53 guibg=#e9e4d0 gui=bold cterm=bold
  hi WinBarNC guifg=#3a4d53 guibg=#e9e4d0 gui=bold cterm=bold
  ...
  hi LspInlayHint guifg=#909995 guibg=NONE gui=NONE cterm=NONE
  hi! link @conditional Conditional
  hi! link @define Define
  hi! link @diff.delta DiffChange
  hi! link @diff.minus DiffDelete
  ...
  hi! link @variable Identifier
  hi! link @exception Exception
  hi RedrawDebugClear guifg=NONE guibg=#a78300 gui=reverse cterm=reverse
  hi RedrawDebugComposed guifg=NONE guibg=#428b00 gui=reverse cterm=reverse
  hi RedrawDebugRecompose guifg=NONE guibg=#cc1729 gui=reverse cterm=reverse
  hi FloatShadow guifg=NONE guibg=#e9e4d0 gui=NONE cterm=NONE
  hi FloatShadowThrough guifg=NONE guibg=#e9e4d0 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi! link StatusLineTerm StatusLine
    hi! link StatusLineTermNC StatusLineNC
    hi NormalFloat ctermfg=NONE ctermbg=238 cterm=NONE
    hi WinBar ctermfg=252 ctermbg=238 cterm=bold
    hi WinBarNC ctermfg=252 ctermbg=238 cterm=bold
    ...
    hi LspInlayHint ctermfg=245 ctermbg=NONE cterm=NONE
    hi! link @conditional Conditional
    hi! link @define Define
    hi! link @diff.delta DiffChange
    hi! link @diff.minus DiffDelete
    ...
    hi! link @variable Identifier
    hi! link @exception Exception
    hi RedrawDebugClear ctermfg=NONE ctermbg=178 cterm=reverse
    hi RedrawDebugComposed ctermfg=NONE ctermbg=113 cterm=reverse
    hi RedrawDebugRecompose ctermfg=NONE ctermbg=203 cterm=reverse
    hi FloatShadow ctermfg=NONE ctermbg=238 cterm=NONE
    hi FloatShadowThrough ctermfg=NONE ctermbg=238 cterm=NONE
    ...
    hi! link StatusLineTerm StatusLine
    hi! link StatusLineTermNC StatusLineNC
    hi NormalFloat ctermfg=NONE ctermbg=187 cterm=NONE
    hi WinBar ctermfg=239 ctermbg=187 cterm=bold
    hi WinBarNC ctermfg=239 ctermbg=187 cterm=bold
    ...
    hi LspInlayHint ctermfg=246 ctermbg=NONE cterm=NONE
    hi! link @conditional Conditional
    hi! link @define Define
    hi! link @diff.delta DiffChange
    hi! link @diff.minus DiffDelete
    ...
    hi! link @variable Identifier
    hi! link @exception Exception
    hi RedrawDebugClear ctermfg=NONE ctermbg=136 cterm=reverse
    hi RedrawDebugComposed ctermfg=NONE ctermbg=28 cterm=reverse
    hi RedrawDebugRecompose ctermfg=NONE ctermbg=160 cterm=reverse
    hi FloatShadow ctermfg=NONE ctermbg=187 cterm=NONE
    hi FloatShadowThrough ctermfg=NONE ctermbg=187 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi WinBar ctermfg=White ctermbg=Black cterm=bold
    hi WinBarNC ctermfg=White ctermbg=Black cterm=bold
    ...
    hi! link @variable Identifier
    hi! link @exception Exception
    hi RedrawDebugClear ctermfg=NONE ctermbg=LightYellow cterm=reverse
    hi RedrawDebugComposed ctermfg=NONE ctermbg=LightGreen cterm=reverse
    hi RedrawDebugRecompose ctermfg=NONE ctermbg=LightRed cterm=reverse
    hi FloatShadow ctermfg=NONE ctermbg=Black cterm=NONE
    hi FloatShadowThrough ctermfg=NONE ctermbg=Black cterm=NONE
